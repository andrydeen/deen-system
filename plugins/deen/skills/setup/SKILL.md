...
- **Guardrails** — passive safety hooks active in every project from the first day (secret scanning, protected files, dangerous-command blocking), plus `/guardrails:rules` to generate per-project coding rules once a codebase matures
